				...
				<div class="col-sm-6">
					...
					<form method="post">
						...
						<div class="form-group">
							...
							<input type="email" name="email" id="email" class="form-control" value="<?php echo isset($row[0]['email'])?$row[0]['email']:''; ?>" placeholder="Enter user email" required>
						...
						<div class="form-group">
							...
							<input type="tel" class="tel form-control" name="mobile" id="mobile" x-autocompletetype="tel" value="<?php echo isset($row[0]['mobile'])?$row[0]['mobile']:''; ?>" placeholder="Enter user phone" required>
