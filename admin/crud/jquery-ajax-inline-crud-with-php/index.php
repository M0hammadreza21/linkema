...
function createNew() {
	...
	'<td><input type="hidden" id="username" /><input type="hidden" id="password" /><span id="confirmAdd"><a onClick="addToDatabase()" class="ajax-action-links">Save</a> / <a onclick="cancelAdd();" class="ajax-action-links">Cancel</a></span></td>' +	
	'</tr>';
...
<table class="tbl-qa">
  ...
  <tbody id="table-body">
	...
	foreach($users as $k=>$v) {
	  ?>
	  <tr class="table-row" id="table-row-<?php echo $users[$k]["id"]; ?>">
		<td contenteditable="true" onBlur="saveToDatabase(this,'username','<?php echo $users[$k]["id"]; ?>')" onClick="editRow(this);"><?php echo $users[$k]["username"]; ?></td>
		<td contenteditable="true" onBlur="saveToDatabase(this,'password','<?php echo $users[$k]["id"]; ?>')" onClick="editRow(this);"><?php echo $users[$k]["password"]; ?></td>
		<td><a class="ajax-action-links" onclick="deleteRecord(<?php echo $users[$k]["id"]; ?>);">Delete</a></td>
	  </tr>
	  <?php
	}
	}
