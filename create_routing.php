...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $stmt = $pdo->prepare("INSERT INTO routing (pid,title,Longitude,Latitude) VALUES (?,?,?,?)"); 
        
        if($stmt->execute([ $profile_id,$title,$Longitude,$Latitude  ])) {
                $stmt = null;
                header("location: https://linkema.com/creator.php?profile_id=".$_POST["profile_id"]);
            } else{
                echo "مشکلی پیش آمده";
            }
...
<head>
  ...
  <title>اضافه کردن یک مسیر جدید | لینک ما</title>
...
<!--====== PRELOADER PART ENDS ======-->
 <div class="container-scroller">
  ...
  <div class="container-scroller" id="mavaranet">
        ...
        <div class="row w-100">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-right p-5">
                ...
                <h2 class="text-center">مسیر جدید</h2>

                    <p>دراین قسمت می توانید مسیر جدیدی را اضافه کنید</p>
...
true // Lazy load the plugin
    ...
    var map = new mapboxgl.Map({
        ...
        center: [51.376091987869415, 35.729376707811824],
        zoom: 7
    });
    map.addControl(
new MapboxGeocoder({
...
mapboxgl: mapboxgl
    ...
    var marker = new mapboxgl.Marker({
        ...
        .setLngLat([51.376091987869415, 35.729376707811824])
        .addTo(map);
    ...
    marker.on('dragend', onDragEnd);
                        ...
                        <input type="submit" class="btn btn-primary" value="ثبت مسیر">
...
$( document ).ready(function() {
    $('input[type="submit"]').attr('disabled', true);
      ...
      $(function() {
        ...
        $("#mavaranet").bind('blur keyup focusout mouseleave', function() {
            check_title();
            check_validation();
         });
