...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	...
	if($username==""){
		...
		$userCount	=	$db->getQueryCount('user','user_id');
				...
				<div class="col-sm-6">
					...
					<form method="post">
						...
						<div class="form-group">
							...
							<input type="tel" class="tel form-control" name="mobile" id="mobile" x-autocompletetype="tel" placeholder="Enter user phone" required>
