...
$sql = "SELECT MAX(position_order) as max_id FROM contacts";  
  ...
  $position_order = $row['max_id']+1;
        ...
        $stmt = $pdo->prepare("INSERT INTO contacts (pid,type,title,value,position_order) VALUES (?,?,?,?,?)"); 
        
        if($stmt->execute([ $profile_id,$type,$title,$value,$position_order  ])) {
                $stmt = null;
                header("location: https://linkema.com/creator.php?profile_id=".$profile_id."&action=create_contact");
            } else{
                echo "مشکلی پیش آمده";
            }
    }
...
<head>
  ...
  <title>ثبت اطلاعات تماس جدید | لینک ما</title>
...
<!--====== PRELOADER PART ENDS ======-->
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper full-page-wrapper" id="mavaranet">
      <div class="content-wrapper d-flex align-items-center auth">
        <div class="row w-100">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-right p-5">
                    <div class="page-header">
                        <h2>اطلاعات تماس جدید</h2>
                    </div>
                    <p>در این قسمت می توانید شماره تلفن، موبایل و آدرس خود را اضافه کنید</p>
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="form-group">
                            <label for="exampleSelectGender">نوع</label>
                            <select class="form-control" name="type" dir="rtl" id="type">
                                <option value="tel">تلفن ثابت</option>
						...
						<div class="form-group">
                            ...
                            <input type="text" dir="ltr" name="value" id="value" class="form-control">
