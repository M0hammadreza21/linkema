...
if(isset($_POST["routing_id"]) && !empty($_POST["routing_id"])){
    ...
    $title = $_POST["title"];
        ...
        $stmt = $pdo->prepare("UPDATE routing SET title=?,Longitude=?,Latitude=? WHERE routing_id=?");

        if(!$stmt->execute([ $title,$Longitude,$Latitude,$routing_id  ])) {
	...
	$_GET["routing_id"] = trim($_GET["routing_id"]);
    if(isset($_GET["routing_id"]) && !empty($_GET["routing_id"])){

        $routing_id =  trim($_GET["routing_id"]);
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                echo "مشکلی پیش آمده. لطفا بعدا سعی کنید";
            }
        }
...
<head>
  ...
  <title>ویرایش مسیر | لینک ما</title>
...
<div class="container-scroller">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-stretch">
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="float-left">
            <a href="creator.php?profile_id=<?php echo $_SESSION['profile_id'];?>" class="btn btn-info">بازگشت</a>
          </li>
        </ul>
      </div>
    </nav>
        ...
        <div class="row w-100">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-right p-5">
                ...
                <h2 style="padding-left=10%;">ویرایش مسیر</h2>
                    <p>با حرکت نشانگر روی نقشه می توانید نشانی مسیرتان را ویرایش کنید</p>
                    <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">

						<div class="form-group">
                            <label>عنوان مسیر</label>
...
<input type="hidden" id="Longitude" name="Longitude" value="3487">
<input type="hidden" id="Latitude" name="Latitude" value="3487">

<script>
	mapboxgl.accessToken = 'pk.eyJ1IjoibWF2YXJhbmV0IiwiYSI6ImNrbTBkeDhoMzFiZTIycWx5OTllbDNheWYifQ.bdljWidGsNrx-_xXCoFDyA';
      ...
      $(function() {
        ...
        function check_title() {
            ...
            if (title.length > 7) {
               ...
               $("#title_error_message").html("عنوان مسیر خیلی کوتاه است");
