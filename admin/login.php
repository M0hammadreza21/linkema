...
{
    header('Location: https://linkema.com/admin/index.php');
}
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
		...
		$sql = "SELECT * from admin WHERE admin_username LIKE '{$admin_username}' AND admin_password LIKE '{$admin_password}' LIMIT 1";
...
<head>
  ...
  <title>ورود به مدیریت | لینک ما</title>
