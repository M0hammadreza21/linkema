...
<head>
  ...
  <title>آمار بازدید صفحه | لینک ما</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="float-left">آمار بازدید از صفحه</h2>
                        </div>

                    <?php
     
                    $profile_id = $_GET["profile_id"];
                    $sql = "SELECT count(*) FROM stats WHERE profile_id = $profile_id";
                    $result = mysqli_query($link, $sql);
                    $row=mysqli_fetch_array($result);
                    $all_visits = $row[0] ;
                    
                    $sql = "SELECT COUNT(DISTINCT visitor_ip) FROM stats WHERE profile_id = $profile_id";
                    $result = mysqli_query($link, $sql);
                    $row=mysqli_fetch_array($result);
                    $all_visitors = $row[0] ;
                    $sql = "SELECT * FROM stats WHERE profile_id = $profile_id";
                    ...
                    if($result = mysqli_query($link, $sql)){
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "<label class='badge badge-gradient-warning'>کل بازدیدها:" .$all_visits."</label>";
                            echo "   ";
                            echo "<label class='badge badge-gradient-info'>کل بازدیدکنندگان:" .$all_visitors."</label>";
                                echo "<thead>";
                                    echo "<tr>";
                                        echo "<th>آی پی آدرس</th>";
                                        echo "<th>سیستم عامل</th>";
                                        echo "<th>مرورگر</th>";
                                        echo "<th>زمان بازدید</th>";
                                    echo "</tr>";
                                echo "</thead>";
                                echo "<tbody>";
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                            ...
                                            echo "<td>" . $row['visitor_os'] . "</td>";
                                            echo "<td>" . $row['visitor_browser'] . "</td>";
                            ...
                            echo "<em class='badge badge-danger'>هنوز بازدیدی برای این صفحه ثبت نشده است</em>";
                        }
                    } else{
